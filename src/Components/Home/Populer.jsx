...
export default function Populer() {
  return (
    <div>
      <h1 className="text-center mt-4 text-2xl font-semibold text-textgray">
        Popular Places to Visit
      </h1>
      <div className="flex justify-center flex-wrap">
        <div className="w-96 shadow-md m-4">
          <img src={colombo} className="object-cover w-96 h-56 " />
          <h1 className="text-center font-semibold">Colombo</h1>
          <div className="bg-slate-200 flex justify-between font-semibold text-textgray">
        ...
        <div className="w-96 shadow-md m-4">
          ...
          <h1 className="text-center font-semibold">Jaffna</h1>
          <div className="bg-slate-200 flex justify-between font-semibold text-textgray">
        ...
        <div className="w-96 shadow-darker m-4 ho">
